...
echo -e "ID\tTotal\tA2\tA3\tA4\tA5\tA6\tA7\tA8\tA9\tA10\tC2\tC3\tC4\tC5\tC6\tC7\tC8\tC9\tC10\tG2\tG3\tG4\tG5\tG6\tG7\tG8\tG9\tG10\tT2\tT3\tT4\tT5\tT6\tT7\tT8\tT9\tT10" > start_polyN.txt
for i in HX{01..04}
do
	...
	echo -e $i"\t"$Total"\t"$A2"\t"$A3"\t"$A4"\t"$A5"\t"$A6"\t"$A7"\t"$A8"\t"$A9"\t"$A10"\t"$C2"\t"$C3"\t"$C4"\t"$C5"\t"$C6"\t"$C7"\t"$C8"\t"$C9"\t"$C10"\t"$G2"\t"$G3"\t"$G4"\t"$G5"\t"$G6"\t"$G7"\t"$G8"\t"$G9"\t"$G10"\t"$T2"\t"$T3"\t"$T4"\t"$T5"\t"$T6"\t"$T7"\t"$T8"\t"$T9"\t"$T10  >> start_polyN.txt
done
